...
The following are two simple MicroOSC programs; the first will receive messages and the second will send them.  Run them in two separate windows and they will talk to each other.
